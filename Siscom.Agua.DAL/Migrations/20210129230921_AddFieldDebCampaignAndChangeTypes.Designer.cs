...
namespace Siscom.Agua.DAL.Migrations
{
    ...
    [Migration("20210129230921_AddFieldDebCampaignAndChangeTypes")]
    partial class AddFieldDebCampaignAndChangeTypes
    {
            ...
            modelBuilder.Entity("Siscom.Agua.DAL.Models.Folio", b =>
                {
                    ...
                    b.Property<DateTime>("DateCurrent")
                        ...
                        .HasDefaultValue(new DateTime(2021, 1, 29, 17, 9, 21, 292, DateTimeKind.Local));
            ...
            modelBuilder.Entity("Siscom.Agua.DAL.Models.ValvulaControl", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, ActualState = "", Description = "Sin Valvula", Diameter = "", HydraulicCircuit = "", IsActive = true, LastServiceDate = new DateTime(2021, 1, 29, 17, 9, 21, 342, DateTimeKind.Local), Latitude = "19.0954579", Longitude = "-98.2792209", PhysicalState = "", Reference = "Sin referencia", Type = "OT011" }
                    );
                });
