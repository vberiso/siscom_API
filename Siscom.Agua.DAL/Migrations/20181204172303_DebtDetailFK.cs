...
{
    public partial class DebtDetailFK : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterColumn<DateTime>(
                ...
                table: "Folio",
                nullable: false,
                defaultValue: new DateTime(2018, 12, 4, 11, 23, 2, 637, DateTimeKind.Local),
                oldClrType: typeof(DateTime),
                oldDefaultValue: new DateTime(2018, 12, 4, 11, 21, 9, 919, DateTimeKind.Local));
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AlterColumn<DateTime>(
                ...
                table: "Folio",
                nullable: false,
                defaultValue: new DateTime(2018, 12, 4, 11, 21, 9, 919, DateTimeKind.Local),
                oldClrType: typeof(DateTime),
                oldDefaultValue: new DateTime(2018, 12, 4, 11, 23, 2, 637, DateTimeKind.Local));
        }
    }
}
