...
namespace Siscom.Agua.DAL.Migrations
{
    ...
    [Migration("20201112190251_alterLengthFromFieldAliasInCONDONATIONCAMPAAING")]
    partial class alterLengthFromFieldAliasInCONDONATIONCAMPAAING
    {
            ...
            modelBuilder.Entity("Siscom.Agua.DAL.Models.Folio", b =>
                {
                    ...
                    b.Property<DateTime>("DateCurrent")
                        ...
                        .HasDefaultValue(new DateTime(2020, 11, 12, 13, 2, 51, 211, DateTimeKind.Local));
            ...
            modelBuilder.Entity("Siscom.Agua.DAL.Models.ValvulaControl", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, ActualState = "", Description = "Sin Valvula", Diameter = "", HydraulicCircuit = "", IsActive = true, LastServiceDate = new DateTime(2020, 11, 12, 13, 2, 51, 264, DateTimeKind.Local), Latitude = "19.0954579", Longitude = "-98.2792209", PhysicalState = "", Reference = "Sin referencia", Type = "OT011" }
                    );
                });
