...
namespace TimboxCancelacionWS
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.1")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="urn:WashOut", ConfigurationName="TimboxCancelacionWS.cancelacion_port")]
    public interface cancelacion_port
    {
        ...
        System.Threading.Tasks.Task<TimboxCancelacionWS.cancelar_cfdi_result> cancelar_cfdiAsync(string username, string password, string rfc_emisor, TimboxCancelacionWS.folios folios, string cert_pem, string llave_pem);
        ...
        System.Threading.Tasks.Task<TimboxCancelacionWS.cancelar_cfdi_externo_result> cancelar_cfdi_externoAsync(string username, string password, string rfc_emisor, TimboxCancelacionWS.folios_externo folios, string cert_pem, string llave_pem);
        ...
        System.Threading.Tasks.Task<TimboxCancelacionWS.cancelar_cfdi_seguro_result> cancelar_cfdi_seguroAsync(string username, string password, string firma_base64);
        ...
        System.Threading.Tasks.Task<TimboxCancelacionWS.consultar_estatus_result> consultar_estatusAsync(string username, string password, string uuid, string rfc_emisor, string rfc_receptor, string total);
        ...
        System.Threading.Tasks.Task<TimboxCancelacionWS.consultar_peticiones_pendientes_result> consultar_peticiones_pendientesAsync(string username, string password, string rfc_receptor, string cert_pem, string llave_pem);
        ...
        System.Threading.Tasks.Task<TimboxCancelacionWS.procesar_respuesta_result> procesar_respuestaAsync(string username, string password, string rfc_receptor, TimboxCancelacionWS.respuestas respuestas, string cert_pem, string llave_pem);
        ...
        System.Threading.Tasks.Task<TimboxCancelacionWS.consultar_documento_relacionado_result> consultar_documento_relacionadoAsync(string username, string password, string uuid, string rfc_receptor, string cert_pem, string llave_pem);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.1")]
    public interface cancelacion_portChannel : TimboxCancelacionWS.cancelacion_port, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.1")]
    public partial class cancelacion_portClient : System.ServiceModel.ClientBase<TimboxCancelacionWS.cancelacion_port>, TimboxCancelacionWS.cancelacion_port
    {
        ...
        public System.Threading.Tasks.Task<TimboxCancelacionWS.cancelar_cfdi_result> cancelar_cfdiAsync(string username, string password, string rfc_emisor, TimboxCancelacionWS.folios folios, string cert_pem, string llave_pem)
        {
            return base.Channel.cancelar_cfdiAsync(username, password, rfc_emisor, folios, cert_pem, llave_pem);
        }
        
        public System.Threading.Tasks.Task<TimboxCancelacionWS.cancelar_cfdi_externo_result> cancelar_cfdi_externoAsync(string username, string password, string rfc_emisor, TimboxCancelacionWS.folios_externo folios, string cert_pem, string llave_pem)
        {
            return base.Channel.cancelar_cfdi_externoAsync(username, password, rfc_emisor, folios, cert_pem, llave_pem);
        }
        
        public System.Threading.Tasks.Task<TimboxCancelacionWS.cancelar_cfdi_seguro_result> cancelar_cfdi_seguroAsync(string username, string password, string firma_base64)
        {
            return base.Channel.cancelar_cfdi_seguroAsync(username, password, firma_base64);
        }
        
        public System.Threading.Tasks.Task<TimboxCancelacionWS.consultar_estatus_result> consultar_estatusAsync(string username, string password, string uuid, string rfc_emisor, string rfc_receptor, string total)
        {
            return base.Channel.consultar_estatusAsync(username, password, uuid, rfc_emisor, rfc_receptor, total);
        }
        
        public System.Threading.Tasks.Task<TimboxCancelacionWS.consultar_peticiones_pendientes_result> consultar_peticiones_pendientesAsync(string username, string password, string rfc_receptor, string cert_pem, string llave_pem)
        {
            return base.Channel.consultar_peticiones_pendientesAsync(username, password, rfc_receptor, cert_pem, llave_pem);
        }
        
        public System.Threading.Tasks.Task<TimboxCancelacionWS.procesar_respuesta_result> procesar_respuestaAsync(string username, string password, string rfc_receptor, TimboxCancelacionWS.respuestas respuestas, string cert_pem, string llave_pem)
        {
            return base.Channel.procesar_respuestaAsync(username, password, rfc_receptor, respuestas, cert_pem, llave_pem);
        }
        
        public System.Threading.Tasks.Task<TimboxCancelacionWS.consultar_documento_relacionado_result> consultar_documento_relacionadoAsync(string username, string password, string uuid, string rfc_receptor, string cert_pem, string llave_pem)
        {
